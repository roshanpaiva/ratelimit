...
func (*RateLimitDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_ratelimit_902c9bd9b12e800e, []int{0}
}
...
func (*RateLimitDescriptor_Entry) Descriptor() ([]byte, []int) {
	return fileDescriptor_ratelimit_902c9bd9b12e800e, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("envoy/api/v2/ratelimit/ratelimit.proto", fileDescriptor_ratelimit_902c9bd9b12e800e)
}

var fileDescriptor_ratelimit_902c9bd9b12e800e = []byte{
