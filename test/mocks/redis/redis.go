...
import (
	...
	v2 "github.com/lyft/ratelimit/proto/envoy/service/ratelimit/v2"
...
// PipeExec mocks base method
func (m *MockConnection) PipeExec(arg0 string, arg1 ...interface{}) redis.Response {
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "PipeExec", varargs...)
	ret0, _ := ret[0].(redis.Response)
	return ret0
}

// PipeExec indicates an expected call of PipeExec
func (mr *MockConnectionMockRecorder) PipeExec(arg0 interface{}, arg1 ...interface{}) *gomock.Call {
	varargs := append([]interface{}{arg0}, arg1...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PipeExec", reflect.TypeOf((*MockConnection)(nil).PipeExec), varargs...)
}
...
// Array mocks base method
func (m *MockResponse) Array() []*redis0.Resp {
	ret := m.ctrl.Call(m, "Array")
	ret0, _ := ret[0].([]*redis0.Resp)
	return ret0
}

// Array indicates an expected call of Array
func (mr *MockResponseMockRecorder) Array() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Array", reflect.TypeOf((*MockResponse)(nil).Array))
}
